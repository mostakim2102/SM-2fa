...
def handle_update(update):
    if "message" in update and "text" in update["message"]:
        ...
        if text == "/start":
            ...
            # ২. শেয়ার মেসেজ (বন্ধুদের ইনবক্সে যা যাবে)
            share_msg = (
                "🔐 <b>অ্যাপ ছাড়াই পেয়ে যান আপনার 2FA লগইন কোড!</b>\n\n"
            ...
            full_share_link = f"https://t.me/share/url?url={encoded_msg}"
            
            inline_keyboard = {
                "inline_keyboard": [
                    # ইনলাইন বাটনের নাম আপনার রিকোয়ারমেন্ট অনুযায়ী সেট করা হয়েছে
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write("Mostakim 2FA code generator bot is successfully active now".encode())
