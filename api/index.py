...
def send_message(chat_id, text, reply_markup=None, disable_preview=False):
    ...
    # এখানে reply_markup পাঠানো নিশ্চিত করার জন্য কড়াকড়িভাবে json.dumps করা হচ্ছে
    if reply_markup:
...
def handle_update(update):
    if "message" in update and "text" in update["message"]:
        ...
        if text == "/start":
            ...
            # সরাসরি পাইথন ডিকশনারি পাঠানো হচ্ছে, যা send_message ফাংশন নিজে থেকে একদম সঠিক JSON স্ট্রিং এ রূপান্তর করে নেবে
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write("Permanent Multi-Admin Bot is Active! 5".encode())
