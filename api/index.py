...
# Upstash Redis Database Credentials (স্টোরেজ কানেক্ট করলে এই নামে অটো সেট হয়)
...
# ==========================================
# ০. Upstash Redis Database ফাংশনসমূহ
# ==========================================

def kv_command(command, *args):
    """Upstash Redis-এ কমান্ড পাঠানোর অফিশিয়াল REST মেকানিজম"""
    if not KV_REST_API_URL or not KV_REST_API_TOKEN:
        return None
    
    # URL এবং Token ঠিক করা
...
def add_user(user_id):
    """ইউনিক ইউজার আইডি ডাটাবেজের 'Set'-এ যুক্ত করা"""
