...
import urllib.parse  # <- /share কমান্ডের জন্য এই ইম্পোর্টটি যোগ করা হয়েছে
import json
import time
import hashlib
import hmac
...
def handle_update(update):
    if "message" in update and "text" in update["message"]:
        ...
        if text == "/start":
            ...
            # বটের মূল মেসেজ (যা ইউজার নিজের চ্যাটে দেখবে)
            share_text = (
            ...
            # শেয়ার করার পর বন্ধুদের ইনবক্সে যে টেক্সট এবং প্রিভিউ যাবে
            ...
            # এখানে reply_markup-কে json.dumps() করে পাঠানো হয়েছে যাতে টেলিগ্রাম এরর না দেয়
