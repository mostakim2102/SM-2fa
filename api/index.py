...
def handle_update(update):
    if "message" in update and "text" in update["message"]:
        ...
        if text == "/start":
            ...
            # প্রধান মেসেজ (বটের নিজস্ব চ্যাটের জন্য)
            share_text = (
            ...
            # বন্ধুদের চ্যাটে পাঠানোর জন্য সুন্দর ডেসক্রিপশন (কোনো লিংক ছাড়া)
            share_msg = "🔐 এই বটটি দিয়ে খুব সহজেই ফেসবুক বা জিমেইলের ২-ফ্যাক্টর (2FA) কোড বের করা যায়। ট্রাই করে দেখতে পারো!"
            bot_link = f"https://t.me/{bot_username}"
            
            encoded_url = urllib.parse.quote_plus(bot_link)
            encoded_text = urllib.parse.quote_plus(share_msg)
            
            # টেলিগ্রাম পিকচার এবং ডেসক্রিপশন প্রিভিউ লোড করানোর জন্য নিখুঁত ফরম্যাট
            full_share_link = f"https://t.me/share/url?url={encoded_url}&text={encoded_text}"
        ...
        if callback_data.startswith("refresh_"):
            ...
            try:
                ...
                inline_keyboard = {
                    "inline_keyboard": [
                        # রিফ্রেশ করার পরও বাটনের নাম থাকবে ওটিপি কোডটি (যেমন: 123 456)
