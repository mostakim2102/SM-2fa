...
def send_message(chat_id, text, reply_markup=None, disable_preview=False):
    # আন্ডারস্কোর জনিত এরর এড়াতে পার্স মোড HTML করা হলো
    payload = {
        "chat_id": chat_id, 
        "text": text, 
        "parse_mode": "HTML",
    ...
    if "message" in update and "text" in update["message"]:
        ...
        if user_id in ADMIN_IDS:
            if text == "/st":
                ...
                # HTML ফরম্যাটে ড্যাশবোর্ড সাজানো হলো
                msg = (
        ...
        if text == "/start":
            ...
            # HTML ফরম্যাটে প্রধান মেসেজ টেক্সট
            share_text = (
            ...
            # বন্ধুদের চ্যাটের মেসেজ (এখানে কোনো HTML ট্যাগ থাকবে না, প্লেইন টেক্সট লিংক হবে)
            share_msg = f"🔐 এই বটটি দিয়ে খুব সহজেই ফেসবুক বা জিমেইলের ২-ফ্যাক্টর (2FA) কোড বের করা যায়। ট্রাই করে দেখতে পারো!\n\n🔗 https://t.me/{bot_username}"
            
            encoded_url = urllib.parse.quote_plus(f"https://t.me/{bot_username}")
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write("Permanent Multi-Admin Bot is Active! 02".encode())
